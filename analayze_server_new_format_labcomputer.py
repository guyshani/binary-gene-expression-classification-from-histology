...
output_dirs = "/home/maruvka/Documents/predict_expression/output_files"
...
for dir in outputdirs:
    ...
    precision, recall, _ = precision_recall_curve(t_labels, model_probs, pos_label=pos_label)
...
df.to_csv(f"{output_dirs}/auc_and_accuracy_labcomputer_21_11.csv")
