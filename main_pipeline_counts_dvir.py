...
def load_data(train_csv, test_csv, bs, num_workers):
	...
	train_data_loader = DataLoader(data['train'], batch_size=bs, shuffle=True, num_workers= 4)
	valid_data_loader = DataLoader(data['valid'], batch_size=bs, shuffle=True, num_workers= 4)
